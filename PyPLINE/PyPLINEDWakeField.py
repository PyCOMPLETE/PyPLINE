...
class PyPLINEDWakeField(WakeField,PyPLINEDElement):
    ...
    def __init__(self,name,number,slicer,*wake_sources):
        print(*wake_sources,wake_sources)
        ...
        bufferSize = self.slicer.n_slices*len(self._attributes_to_buffer)+1
    ...
    def _slice_set_from_buffer(self,slice_set0):
        ...
        slice_set_kwargs['beam_parameters'] = {'beta':slice_set0.beta}
    ...
    def track(self, beam, partnerIDs):
        ...
        for partnerID in partnerIDs:
            ...
            self.slice_set_age_deque[beam.ID.number].appendleft(partner_delay-beam.delay)
